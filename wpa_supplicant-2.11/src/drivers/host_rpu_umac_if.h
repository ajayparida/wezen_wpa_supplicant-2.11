...
#define NRF_WIFI_CMD_AUTHENTICATE_TRANSMITTED_BSSID_VALID (1 <<6)
...
struct nrf_wifi_umac_auth_info {
	...
	/** Transmitted bss_valid_flag */
        unsigned char transmitted_bssid_valid;
        /** Transmitted bssid */
        unsigned char transmitted_bssid[NRF_WIFI_ETH_ADDR_LEN];
} __NRF_WIFI_PKD;
