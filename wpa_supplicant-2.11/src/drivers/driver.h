...
/**
 * struct nrf_wifi_dispaly_scan_results - DISPLAY Scan results
 * @res: Array of pointers to allocated variable length scan result entries
 * @num: Number of entries in the scan result array
 */
struct nrf_wifi_display_scan_results {
...
#ifdef CFG_INTERFACE
#ifdef BSS_OPTIMIZATION
	int (*display_scan)(void *priv);
	int (*retrieve_display_scan_results)(void *priv);
	int (*get_display_scan_results)(void *priv, char *buf, size_t len);
#endif
#endif
};
